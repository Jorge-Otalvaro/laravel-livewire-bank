...
<head>
    ...
    <title>Laravel</title>
    <link href="{{ asset('plantilla/css/font-awesome.css') }}" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="{{ asset('plantilla/owl-carousel/assets/owl.carousel.min.css') }}" type="text/css">
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light bg-transparent" id="gtco-main-nav">
        <div class="container"><a class="navbar-brand">Bank Solution</a>
            ...
            <div id="my-nav" class="collapse navbar-collapse">
                ...
                <form class="form-inline my-2 my-lg-0">
                    @if (Route::has('login'))
                        @auth
                            <a href="{{ url('/dashboard') }}" class="btn btn-info my-2 my-sm-0 mr-3 text-uppercase">{{ __('Dashboard') }}</a> 
                        @else
                            <a href="{{ route('login') }}" class="btn btn-outline-dark my-2 my-sm-0 text-uppercase">{{ __('Banking Operations') }}</a>
                        @endauth
                    @endif
                </form>
            </div>
    ...
    <div class="container-fluid gtco-banner-area">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card"><img class="card-img-top img-fluid" src="{{ asset('plantilla/images/banner-img.png') }}" alt=""></div>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="cover">
                        <div class="card">
                            ...
                            <svg width="100%" viewBox="0 0 700 500">
                                ...
                                <image clip-path="url(#clip-path)" xlink:href="{{ asset('plantilla/images/learn-img.jpg') }}" width="100%"
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card text-center">
                                <div class="oval"><img class="card-img-top" src="{{ asset('plantilla/images/web-design.png') }}" alt=""></div>
                                <div class="card-body">
                            ...
                            <div class="card text-center">
                                <div class="oval"><img class="card-img-top" src="{{ asset('plantilla/images/marketing.png') }}" alt=""></div>
                                <div class="card-body">
                        ...
                        <div class="col">
                            <div class="card text-center">
                                <div class="oval"><img class="card-img-top" src="{{ asset('plantilla/images/seo.png') }}" alt=""></div>
                                <div class="card-body">
                            ...
                            <div class="card text-center">
                                <div class="oval"><img class="card-img-top" src="{{ asset('plantilla/images/graphics-design.png') }}" alt=""></div>
                                <div class="card-body">
    ...
    <div class="container-fluid gtco-numbers-block">
        <div class="container">
            <svg width="100%" viewBox="0 0 1600 400">
                ...
                <!-- xlink:href for modern browsers, src for IE8- -->
                <image  clip-path="url(#ctm)" xlink:href="{{ asset('plantilla/images/word-map.png') }}" height="800px" width="100%" class="svg__image">
    ...
    <div class="container-fluid gtco-testimonials">
        <div class="container">
            ...
            <div class="owl-carousel owl-carousel1 owl-theme">
                <div>
                    <div class="card text-center"><img class="card-img-top" src="{{ asset('plantilla/images/customer1.jpg') }}" alt="">
                        <div class="card-body">
                            <h5>Lisa Gally <br/>
                ...
                <div>
                    <div class="card text-center"><img class="card-img-top" src="{{ asset('plantilla/images/customer2.jpg') }}" alt="">
                        <div class="card-body">
                            <h5>Missy Limana<br/>
                                <span> Project Manager </span></h5>
                            <p class="card-text">“ Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil
                ...
                <div>
                    <div class="card text-center"><img class="card-img-top" src="{{ asset('plantilla/images/customer3.jpg') }}" alt="">
                        <div class="card-body">
                            <h5>Aana Brown<br/>
                                <span> Project Manager </span></h5>
                            <p class="card-text">“ Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil
        ...
        <div class="container">
            <div class="row">
                <div class="media col-md-6 col-lg-4">
                    <div class="oval mr-4"><img class="align-self-start" src="{{ asset('plantilla/images/quality-results.png') }}" alt=""></div>
                ...
                <div class="media col-md-6 col-lg-4">
                    <div class="oval mr-4"><img class="align-self-start" src="{{ asset('plantilla/images/analytics.png') }}" alt=""></div>
                    <div class="media-body">
                ...
                <div class="media col-md-6 col-lg-4">
                    <div class="oval mr-4"><img class="align-self-start" src="{{ asset('plantilla/images/affordable-pricing.png') }}" alt=""></div>
                    <div class="media-body">
                ...
                <div class="media col-md-6 col-lg-4">
                    <div class="oval mr-4"><img class="align-self-start" src="{{ asset('plantilla/images/easy-to-use.png') }}" alt=""></div>
                    <div class="media-body">
                ...
                <div class="media col-md-6 col-lg-4">
                    <div class="oval mr-4"><img class="align-self-start" src="{{ asset('plantilla/images/free-support.png') }}" alt=""></div>
                    <div class="media-body">
                ...
                <div class="media col-md-6 col-lg-4">
                    <div class="oval mr-4"><img class="align-self-start" src="{{ asset('plantilla/images/effectively-increase.png') }}" alt=""></div>
                    <div class="media-body">
    ...
    <div class="container">
        <div class="row">
            <div class="col"><img src="{{ asset('plantilla/images/logo1.png') }}" class="img-fluid" alt=""></div>
            <div class="col"><img src="{{ asset('plantilla/images/logo2.png') }}" class="img-fluid" alt=""></div>
            <div class="col"><img src="{{ asset('plantilla/images/logo3.png') }}" class="img-fluid" alt=""></div>
            <div class="col"><img src="{{ asset('plantilla/images/logo4.png') }}" class="img-fluid" alt=""></div>
            <div class="col"><img src="{{ asset('plantilla/images/logo5.png') }}" class="img-fluid" alt=""></div>
        </div>
    </div>
    </div>
    ...
    <div class="container-fluid gtco-news" id="news">
        <div class="container">
            ...
            <div class="owl-carousel owl-carousel2 owl-theme">
                <div>
                    <div class="card text-center"><img class="card-img-top" src="{{ asset('plantilla/images/news1.jpg') }}" alt="">
                ...
                <div>
                    <div class="card text-center"><img class="card-img-top" src="{{ asset('plantilla/images/news2.jpg') }}" alt="">
                        <div class="card-body text-left pr-0 pl-0">
                ...
                <div>
                    <div class="card text-center"><img class="card-img-top" src="{{ asset('plantilla/images/news3.jpg') }}" alt="">
                        <div class="card-body text-left pr-0 pl-0">
    ...
    <script src="{{ asset('plantilla/js/jquery-3.3.1.slim.min.js') }}"></script>
    <script src="{{ asset('plantilla/js/popper.min.js') }}"></script>
    <script src="{{ asset('plantilla/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('plantilla/owl-carousel/owl.carousel.min.js') }}"></script>
